package Tree::Builder::Parser;

use strict;
use warnings;

use FileHandle;
use Tree::Builder::Data;
use Tree::Builder::Tokenizer;
...
Tree::Builder::Parser - Parse Tree Definitions
...
Parses C<$datafile> and returns an instance of L<Tree::Builder::Data>
...
sub parseFile {
    ...
    $self->{error}     = '';
    $self->{data}      = new Tree::Builder::Data();
    $self->{tokenizer} = new Tree::Builder::Tokenizer($datafile);
